...
void _loadWeeklyNutritionData() {
  ...
  FirebaseFirestore.instance
    ...
    if (firstMealSnapshot.docs.isNotEmpty) {
      // Ila kayn repas, nbeddaw mn nhar l'premier repas
      ...
      // Ila makayn ta repas, nbeddaw mn 7 jours li fatو
    ...
    _weeklySubscription = FirebaseFirestore.instance
      ...
      // Nconstruiw les 7 jours mn startDate
      ...
      for (int i = 0; i < 7; i++) {
        ...
        // Valeurs statiques pour glycémie w sport
      ...
      print('📄 Nombre de repas trouvés: ${querySnapshot.docs.length}');
      print('📅 Période: $startDate à $endDate');
      ...
      for (final doc in querySnapshot.docs) {
        ...
        print('📝 Repas: ${data['name']}, DateKey: $dateKey, Glucides: $glucides');
      ...
      // Reconstruction dans l'ordre chronologique (mn startDate l 7 jours)
      ...
      print('📊 Glucides par jour: ${combinedData.map((d) => '${d.day}:${d.glucides}g').join(', ')}');
    ...
    // Reconstruction dans l'ordre chronologique
    //
